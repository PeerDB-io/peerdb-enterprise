...
![Version: 0.9.11](https://img.shields.io/badge/Version-0.9.11-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.36.7](https://img.shields.io/badge/AppVersion-v0.36.7-informational?style=flat-square)
...
| peerdb.version | string | `"stable-v0.36.7"` | This version is overridden by .env file if the install_peerdb.sh script is being used In that case, either update the .env file or override it via values.customer.yaml when installing |
